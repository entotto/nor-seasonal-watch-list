...
final class ApiKeyAuthenticator extends AbstractGuardAuthenticator
{
     ...
     *
     * @return string|null Any non-null value
     *
    ...
    public function getUser($credentials, UserProviderInterface $userProvider): ?UserInterface
    {
        ...
        return $this->userRepository->findByApiKey($credentials);
    }
    ...
    public function checkCredentials($credentials, UserInterface $user): bool
    {
        ...
        $thisUser = $this->userRepository->findByApiKey($credentials);
        return $thisUser !== null && $thisUser->getUsername() === $user->getUsername();
    }
